...
class Constant {
  ...
  static String hostUrl = "https://admin.saimshoppingmall.com/";

  static String baseUrl = "${hostUrl}customer/";
  static String packageName = "com.mw.customer";
  static String appStoreUrl = "https://testflight.apple.com/join/fcRe3J9F";
  static String playStoreUrl =
      "https://play.google.com/store/apps/details?id=$packageName";

  static String appStoreId = "com.mw.customer";

  static String deepLinkPrefix = "https://com.mw.customer.page.link";
  ...
  static String initialCountryCode =
      "PK"; // initial country code, change as per your requirement
  ...
  //google api keys
  static String googleApiKey = "AIzaSyB4yJXGcknACV3fyZWR6rlsuPnyFarXQzQ";
