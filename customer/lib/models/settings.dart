...
class SettingsData {
  ...
  SettingsData.fromJson(Map<String, dynamic> json) {
    ...
    defaultCity = json['default_city'] != null
        ? DefaultCity.fromJson(json['default_city'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['area_wise_delivery_charge'] = areaWiseDeliveryCharge;
    data['min_amount'] = minAmount;
    data['delivery_charge'] = deliveryCharge;
    data['is_refer_earn_on'] = isReferEarnOn;
    data['min_refer_earn_order_amount'] = minReferEarnOrderAmount;
    data['refer_earn_bonus'] = referEarnBonus;
    data['refer_earn_method'] = referEarnMethod;
    data['max_refer_earn_amount'] = maxReferEarnAmount;
    data['minimum_withdrawal_amount'] = minimumWithdrawalAmount;
    data['max_product_return_days'] = maxProductReturnDays;
    data['delivery_boy_bonus_percentage'] = deliveryBoyBonusPercentage;
    data['user_wallet_refill_limit'] = userWalletRefillLimit;
    ...
    data['time_slots_is_enabled'] = timeSlotsIsEnabled;
    data['time_slots_delivery_starts_from'] = timeSlotsDeliveryStartsFrom;
    data['time_slots_allowed_days'] = timeSlotsAllowedDays;
    data['privacy_policy'] = privacyPolicy;
    data['returns_and_exchanges_policy'] = returnsAndExchangesPolicy;
    ...
    data['app_mode_seller_remark'] = appModeSellerRemark;
    ...
    if (defaultCity != null) {
      data['default_city'] = defaultCity!.toJson();
    }
    data['favorite_product_ids'] = favoriteProductIds;
    return data;
  }
}
